...
class SfTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 24.8, fontWeight: FontWeight.w600, color: Colors.black),
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 14.8, fontWeight: FontWeight.w500, color: Colors.black.withOpacity(0.5)),
    //
  ...
  static TextTheme DarkTextTheme = TextTheme(
    headlineMedium: const TextStyle().copyWith(fontSize: 24.8, fontWeight: FontWeight.w600, color: Colors.white),
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 14.8, fontWeight: FontWeight.w500, color: Colors.white.withOpacity(0.5)),
    //
